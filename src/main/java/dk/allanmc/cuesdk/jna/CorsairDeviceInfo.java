 ...
 * <i>native declaration : target\CUESDK\include\CUESDK.h:143</i><br>
...
public class CorsairDeviceInfo extends Structure {
    ...
    /**
     * structure that describes channels of the DIY-devices.<br>
     * C type : CorsairChannelsInfo
     */
     ...
     * @param ledsCount      number of controllable LEDs on the device.<br>
     * @param channels       structure that describes channels of the DIY-devices.<br>
     *                       C type : CorsairChannelsInfo
     */
    public CorsairDeviceInfo(int type, Pointer model, int physicalLayout, int logicalLayout, int capsMask, int ledsCount, CorsairChannelsInfo channels) {
        super();
        this.type = type;
        this.model = model;
    ...
    protected List<?> getFieldOrder() {
        return Arrays.asList("type", "model", "physicalLayout", "logicalLayout", "capsMask", "ledsCount", "channels");
    }
